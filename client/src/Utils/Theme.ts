...
export const Theme = {
  ...
  input: "w-full rounded-md border-2 bg-gray-200 border-gray-200 py-1 px-2 data-[invalid=true]:border-red-700 has-[input:focus-within]:border-primary-950 has-[input:read-only]:bg-gray-200 has-[input:read-only]:text-gray-600 flex items-center",
  textarea: "w-full rounded-md border-2 bg-gray-200 border-gray-200 py-1 px-2 data-[invalid=true]:border-red-700 has-[textarea:focus-within]:border-primary-950 has-[textarea:read-only]:bg-gray-400 has-[textarea:read-only]:text-gray-600 flex items-center",
